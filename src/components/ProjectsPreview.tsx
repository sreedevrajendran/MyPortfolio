...
const featuredProjects = [
  ...
  },
  {
    ...
    emoji: "🌤️",
    status: "Released",
    description: "A high-performance, real-time native Android weather application built using React Native. Features precise location-aware forecasting and a highly dynamic, responsive user interface.",
  ...
  },
  {
    ...
    emoji: "📅",
    status: "Live",
    description: "An analytical tool designed to help students strategically manage their attendance. Calculates exact class allowances while ensuring compliance with institutional attendance thresholds.",
